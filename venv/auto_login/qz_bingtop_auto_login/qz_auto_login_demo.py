...
# @Time : 2021/12/16 10:33 
# @Author : J.wang 
# @Version：V 0.1 
# @File : qz_auto_login_demo.py
# @Software: PyCharm
# @desc :
...
print(size)
# driver.close()
rangle = (a1[0] * 1.00, a1[1] * 1.00, a1[0] * 1.00 + a2[1] * 1.002,
          a1[1] * 1.00 + a2[0] * 0.89)  # (x,y,x+width,y+height)  注意本机设置的缩放比例为125%，故所有元素*1.25
print(rangle)
