...
class chinese_city():
    ...
    def __init__(self):
        ...
        self.conn = pymysql.connect(host="localhost", port=3306, user="root", passwd="159611", db="python_mysql",
                                    charset='utf8')
    ...
    def crawl_page(self, url):
        ...
        headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100102 Firefox/71.0',
    ...
    def insert_to_db(self, taobao):
        ...
        lastid = 0
        try:
            sql = 'INSERT INTO tab_citys1 values(%s,%s,%s,%s,%s, %s)'
