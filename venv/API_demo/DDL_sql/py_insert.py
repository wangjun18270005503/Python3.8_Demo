...
def dict_column_comment_insert(create_name, table_comment, columns, dict_name):
    ...
    print('\033[0;33;40mtable_name:\033[0m', table_name, '\033[0;33;40m\tcolumns：\033[0m', columns_v, '\033[0;33;40m\tvalues：\033[0m', values_v)
...
if __name__ == '__main__':
    body_info = {'code': '00', 'msg': '成功', 'datas': [{'guardian_add': '', 'address': '浙江省江山市四都镇上峰村上埂头５８号', 'guardian_name': '郑四根富', 'pk_id': 'B9B18FCFD6B04CA6AF8C96C6E0C8C15D', 'gender': '男', 'nation': '汉族', 'birth_date': '1990-12-16', 'disable_leve': '三级', 'disable_type': '肢体残疾', 'guardian_ide': '', 'guardian_relation': '父母', 'identity_card': '330881199012160714', 'native_place': '浙江省江山市四都镇上峰村上埂头５８号', 'disable_card': '33088119901216071443', 'issue_date': '2021-07-20', 'phone': '18357065836', 'name': '郑川川', 'guardian_phone': '18357065836', 'tong_time': '2021-10-21 23:51:14.0'}], 'dataCount': 1, 'requestId': 'b126b1ff226d4c679de5f9f679f6a8b9'}
